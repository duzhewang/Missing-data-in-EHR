#------------------------------------------------------------
# This script is used to update mcmc
# Last updated date: 8/7/2017
#------------------------------------------------------------
source("/Users/peterwang/Dropbox/missingdata/Project/code/MCARSim/f8/MCAR_data_generation_f8.R")
...
#maxdiff.ini.X=max(datfrm$X-X_sim)
#mindiff.ini.X=min(datfrm$X-X_sim)
