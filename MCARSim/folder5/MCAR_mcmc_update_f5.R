...
#------------------------------------------------------------
setwd("/Users/peterwang/Desktop/Research/missingdata/Project/code/MCARSim/folder5")
source("MCAR_data_generation_f5.R")
