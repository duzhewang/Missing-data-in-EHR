---
title: "MCAR simulation-folder5"
date: "7/27/2017"
output: pdf_document
---
Method summary: update $\beta$ NOT conditioned on $b_{i}$, impute the initial value of missing $X_{it}$ using linear interpolation and update missing $X_{it}$ using M-H algorithm. 
...
time=system.time(source("MCAR_mcmc_update_f5.R")) 
```
...
**Difference between mean of multiple imputed X and their true value**
```{r}
##mean of imputed X
