...
#------------------------------------------------------------
source("/Users/peterwang/Dropbox/missingdata/Project/code/MCARSim/f6/MCAR_data_generation_f6.R")
...
for(i in 1:n){
  X_sim[datfrm$Subject==i]=na.interpolation(X_sim[datfrm$Subject==i], option = "linear")
}
