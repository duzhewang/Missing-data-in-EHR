...
# the initial value is VERY different with the true values
# Last updated date: 8/7/2017
#----------------------------------------------------------------------------------
source("/Users/peterwang/Dropbox/missingdata/Project/code/Obsfit/f2/MCAR_data_generation_obs_f2.R")
